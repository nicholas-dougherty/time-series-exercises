#  ________  ________  ________  ___  ___  ___  ________  _______      
# |\   __  \|\   ____\|\   __  \|\  \|\  \|\  \|\   __  \|\  ___ \     
# \ \  \|\  \ \  \___|\ \  \|\  \ \  \\\  \ \  \ \  \|\  \ \   __/|    
#  \ \   __  \ \  \    \ \  \\\  \ \  \\\  \ \  \ \   _  _\ \  \_|/__  
#   \ \  \ \  \ \  \____\ \  \\\  \ \  \\\  \ \  \ \  \\  \\ \  \_|\ \ 
#    \ \__\ \__\ \_______\ \_____  \ \_______\ \__\ \__\\ _\\ \_______\
#     \|__|\|__|\|_______|\|___| \__\|_______|\|__|\|__|\|__|\|_______|
#                               \|__|                                                                                                                                                                          
'''
...
If you want to get the individual datasets from the store
item demand data you can do so with
- get_items_data
- get_stores_dat
- get_sales_data
'''
...
def get_items_data_from_api():
    ...
    while True:
        ...
        response = requests.get(url)
        data = response.json()
        print(f'\rGetting page {data["payload"]["page"]} of
              {data["payload"]["max_page"]}: {url}', end='')
